...
from research.legacy_backend.datasets.base import (
    CLINTOX_CONFIG,
    CLINTOX_TASKS,
    TOX21_CONFIG,
    TOX21_TASKS,
...
from research.legacy_backend.datasets.clintox import load_clintox
from research.legacy_backend.datasets.tox21 import load_tox21
