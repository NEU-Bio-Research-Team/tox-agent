...
Model Types:
-----------
- **MLP Model** (Self-designed): FingerprintMLP from research.legacy_backend.models
  - Input: Morgan fingerprints (fixed-length vectors)
  - Framework: PyTorch (custom training loop)
    - Featurization: research.legacy_backend.featurization.featurize_batch(mode="fingerprint")
...
from research.legacy_backend.models import create_baseline_model
from research.legacy_backend.train import (
    train_baseline_model,
    evaluate_model,
    predict_with_torch_molecule_model
)
from research.legacy_backend.utils import set_seed, get_default_config, save_metrics
