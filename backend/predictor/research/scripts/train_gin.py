...
from research.legacy_backend.graph_models_gin import create_gin_model
from research.legacy_backend.graph_train import train_gatv2_model, evaluate_model, create_balanced_sampler
from research.legacy_backend.utils import set_seed, save_metrics
...
def main():
    assert_clintox_enabled("scripts/train_gin.py")
    ...
    model_dir = project_root / output_config.get('model_dir', '.data/models/gin_model')
