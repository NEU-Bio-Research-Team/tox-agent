...
from research.legacy_backend.pretrained_mol_model import create_pretrained_mol_model
from research.legacy_backend.graph_train import MaskedFocalLoss
...
def main():
    ...
    print("=" * 70)
    print(f"ChemBERTa-2 — Tox21 ({mc['pretrained_model']})")
    print("=" * 70)
    ...
    out_dir = project_root / oc.get("model_dir", ".data/models/tox21_chemberta_model")
