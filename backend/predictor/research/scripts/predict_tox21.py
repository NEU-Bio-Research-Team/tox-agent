...
from research.legacy_backend.inference import load_tox21_gatv2_model, predict_tox21_batch
...
def main() -> None:
    ...
    parser.add_argument("--model-dir", type=str, default=".data/models/tox21_gatv2_model")
