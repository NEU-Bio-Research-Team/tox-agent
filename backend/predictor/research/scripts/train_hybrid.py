...
from research.legacy_backend.graph_data import smiles_list_to_pyg_dataset, get_feature_dims
...
from research.legacy_backend.graph_train import train_gatv2_model as train_graph_model, evaluate_model, create_balanced_sampler
from research.legacy_backend.utils import set_seed, save_metrics, ensure_dir
...
def main():
    ...
    model_dir = project_root / output_config.get('model_dir', '.data/models/smilesgnn_model')
