...
from research.legacy_backend.clinical_head import calibrate_threshold_youden, calibrate_threshold_youden_cv, compute_binary_metrics
...
from research.legacy_backend.pretrained_mol_model import (
...
def main() -> None:
    ...
    model_dir_rel = args.output_dir or output_cfg.get("model_dir", ".data/models/pretrained_2head_herg_tox21_model")
