...
from research.legacy_backend.clinical_head import (
...
from research.legacy_backend.graph_data import get_feature_dims, smiles_list_to_pyg_dataset
from research.legacy_backend.graph_models_hybrid import create_hybrid_model
from research.legacy_backend.graph_train import (
    FocalLoss,
...
from research.legacy_backend.workspace_mode import assert_tox21_enabled
...
def main() -> None:
    ...
    model_dir_rel = args.output_dir or output_cfg.get("model_dir", ".data/models/smilesgnn_herg_exp_model")
