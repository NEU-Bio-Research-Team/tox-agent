...
from research.legacy_backend.graph_data import smiles_list_to_pyg_dataset, get_feature_dims, smiles_to_pyg_data
from research.legacy_backend.graph_models_hybrid import create_hybrid_model
from research.legacy_backend.gnn_explainer import (
    explain_molecule,
...
def main():
    ...
    parser.add_argument(
        "--model-dir", type=str, default=".data/models/smilesgnn_model",
        help="Path to trained model directory. Default: .data/models/smilesgnn_model.",
    )
    parser.add_argument(
