...
from research.legacy_backend.graph_train import create_balanced_sampler, evaluate_model, train_gatv2_model
from research.legacy_backend.utils import save_metrics, set_seed
...
def main():
    ...
    model_dir = project_root / output_config.get('model_dir', '.data/models/gatv2_transfer_model')
