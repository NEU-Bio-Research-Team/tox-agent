...
from research.legacy_backend.attentivefp_model import create_attentivefp_model
...
def main():
    ...
    out_dir = project_root / oc.get("model_dir", ".data/models/tox21_attentivefp_model")
