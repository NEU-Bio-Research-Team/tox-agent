...
Usage:
  PYTHONPATH=backend/predictor python backend/predictor/evals/benchmark/run_benchmark.py                 # full frozen split
  PYTHONPATH=backend/predictor python backend/predictor/evals/benchmark/run_benchmark.py --limit 100     # smoke size, for CI
"""
...
def main() -> int:
    ...
    recorded_path = (
        ROOT / ".data" / "models" / "pretrained_2head_herg_chemberta_model"
