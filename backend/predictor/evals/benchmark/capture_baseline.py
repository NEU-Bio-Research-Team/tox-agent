...
SERVING_ARTIFACTS = {
    "clintox-smilesgnn": ROOT / ".data" / "models" / "smilesgnn_model",
    "herg-tox21-chemberta": ROOT / ".data" / "models" / "pretrained_2head_herg_chemberta_model",
}
...
def capture_clintox(panel: dict) -> dict:
    ...
    to be swallowed."""
    from research.legacy_backend.inference import load_model
