...
export function SessionConfigPopover({ sessionId }: { sessionId: string }) {
  ...
  const [connections, setConnections] = useState<Array<{ connection_id: string; provider_id: string; model_id: string; status: string }>>([]);
